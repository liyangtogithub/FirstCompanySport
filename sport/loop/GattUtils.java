...
public class GattUtils {
	...
	public static final String CONNECT_STATE_BROAD="desay.sport.connectstate";
	public static final String DISCONNECT_STATE_BROAD="desay.sport.disconnected";
	public static final String NOT_PAIRED="desay.sport.notpaired";
	public static final String CONNECTE_SUCCESS="desay.sport.connect";
	public static final String CONNECTE_FAILD="desay.sport.disconnect";
	public static final String CONFIRM_MSG="desay.sport.confirm";
	public static final String BOX_CONFIRM="desay.sport.boxconfirm";
